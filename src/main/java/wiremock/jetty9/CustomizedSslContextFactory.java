 ...
 *
 * <p>This class is customized because the Android JVM classes do not support the
 * `setEndpointIdentificationAlgorithm` for https communication.
 */
  ...
  public void customize(SSLEngine sslEngine) {
    ...
    sslEngine.setEnabledCipherSuites(
        super.selectCipherSuites(
            sslEngine.getEnabledCipherSuites(), sslEngine.getSupportedCipherSuites()));
