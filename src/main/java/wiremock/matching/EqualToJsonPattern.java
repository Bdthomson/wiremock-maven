...
import static wiremock.common.Json.deepSize;
import static wiremock.common.Json.maxDeepSize;
...
public class EqualToJsonPattern extends StringValuePattern {
    ...
    try {
      ...
      return new MatchResult() {
        ...
        public boolean isExactMatch() {
          ...
          return (!shouldIgnoreArrayOrder()
                  && !shouldIgnoreExtraElements()
  ...
  private static final class DecodePathFunction implements Function<String, String> {

    @Override
    public String apply(String path) {
      return path.replaceAll("~1", "/")
          .replaceAll("~0", "~"); // see http://tools.ietf.org/html/rfc6901#section-4
    }
  }
}
